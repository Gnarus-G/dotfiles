...
Delegation is optional. Use bounded implementation through the
`claude-implement` skill only when external execution has a clear advantage.

Keep reasoning, planning, judgment, and review inline. Define the task and done
criteria yourself, then inspect and verify any delegated result before using it.
